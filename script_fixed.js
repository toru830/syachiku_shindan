...
function getResultType(normalizedScores) {
    ...
    const patternMap = {
        ...
        'medium-high-medium-medium': resultTypes[9], // デキる社員
        // === MEDIUM-MEDIUM ===
        ...
        'low-high-medium-medium': resultTypes[9], // デキる社員
        // === LOW-MEDIUM ===
        ...
        'low-low-low-low': resultTypes[14],      // 普通の社員
    ...
    if (result) {
        ...
        return resultTypes[14]; // フォールバック: 普通の社員
    }
