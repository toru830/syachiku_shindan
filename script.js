...
function showResult() {
    ...
    const TYPES = {
      ...
      FREE: { key:"FREE", name:"自由人", icon:"🕊️",
        ...
        comment: "しごと？なにそれ？それよりYoutube見た？",
        level: 0,
...
function transferToShachipoke() {
    try {
        ...
        showVideoModal('https://pub-db3c77241ee44812b4924bae7099bcee.r2.dev/20_movie/Intro02.mp4', 'https://shachipoke.syachiku-life.com/');
